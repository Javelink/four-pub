...
extension SearchControllerEnum {
    ...
    var title: String {
        ...
        case .coffeAndTea:  return "Coffe and Tea"
    ...
    var image: UIImage {
        ...
        case .coffeAndTea: 	return UIImage(named: "coffeAndTea")!
        case .night:        return UIImage(named: "night")!
        case .work:         return UIImage(named: "work")!
        case .movie:        return UIImage(named: "movie")!
        case .park:         return UIImage(named: "park")!
        case .gallery:      return UIImage(named: "museum")!
        case .museum:       return UIImage(named: "art-gallery")!
        }
    }
}
